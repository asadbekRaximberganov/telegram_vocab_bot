...
async def process_answer(callback: CallbackQuery, state: FSMContext):
    ...
    # callback.data = "answer_{q_index}_{a_index}"
    ...
    # Eski savol tugmasi bosilganligi
    ...
    if is_correct:
        ...
        feedback = (
            f"✅ <b>To'g'ri!</b>\n\n"
            f"🔤 {question['word']} = <b>{correct_answer}</b>"
        )
    else:
        wrong += 1
        feedback = (
    ...
    # Oldingi savol tugmalarini o'chirish
    try:
